...
async def google_callback(request: Request, response: Response, db: Session = Depends(get_db)):
    ...
    return _issue_tokens_and_redirect(db, user, response)
...
def _issue_tokens_and_redirect(db, user, response: Response) -> RedirectResponse:
    ...
    # Pass access token as a query param so the frontend can pick it up
